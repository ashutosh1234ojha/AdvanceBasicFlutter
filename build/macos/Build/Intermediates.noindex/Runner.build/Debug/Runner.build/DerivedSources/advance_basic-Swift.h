...
#ifndef ADVANCE_BASIC_SWIFT_H
#define ADVANCE_BASIC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="advance_basic",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC13advance_basic11AppDelegate")
...
SWIFT_CLASS("_TtC13advance_basic17MainFlutterWindow")
